...
class GridGenerator(nn.Module):
    ...
    def __init__(self, F, I_r_size):
        ...
        ## for fine-tuning with different image width, you may use below instead of self.register_buffer #--uncommented below two lines--sumit...commented above two lines.
        ...
        self.inv_delta_C = self.inv_delta_C.to(device)
        self.P_hat = self.P_hat.to(device)
